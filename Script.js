...
const PROJECTS = [
  ...
  },
  {
    ...
    name: "Garment Decor", industry: "Apparel Screen-Printing & Embroidery · B2B", platform: "WooCommerce", techStack: "WordPress / Custom Printing Engine",
  ...
  /* ================= TAB — BRAND IDENTITY =================
     Featured order per your request: El Paraíso, Massalino, Disfruta,
     Casa Santafé, Casa de Encantos, Pawty Animals — first, in that order.
     Denali / Bark 2 Earth / Biona / Emraw moved down into the lighter
     BRAND_GALLERY strip below. */
  {
    ...
    gallery: ["images/paraiso-thumb.jpg"],
  ...
  },
  {
    ...
    gallery: ["images/massalino-thumb.jpg"],
  ...
  },
  {
    ...
    gallery: ["images/disfruta-thumb.jpg"],
  ...
  },
  {
    ...
    gallery: ["images/casasantafe-thumb.jpg"],
  ...
  },
  {
    ...
    thumbnail: "images/casadeencantos-thumb.jpg",
    gallery: ["images/casadeencantos-thumb.jpg"],
  ...
  },
  {
    ...
    gallery: ["images/pawtyanimals-thumb.jpg"],
  ...
  },
  {
    ...
    name: "Rasa", industry: "Adaptogenic Coffee Alternative · DTC", platform: "Email Marketing", liveUrl: "https://wearerasa.com/",
    role: "Email Design",
    desc: "Designed campaigns for an adaptogenic coffee-alternative DTC brand.",
  ...
  },
  {
    ...
    name: "Tiny Rituals", industry: "Wellness & Self-Care · DTC", platform: "Email Marketing", liveUrl: "https://tinyrituals.co/",
    role: "Email Design",
    desc: "Designed campaigns for a wellness and self-care DTC brand.",
  ...
  },
  {
    ...
    name: "Static Nails", industry: "Beauty · Press-On Nails · DTC", platform: "Email Marketing", liveUrl: "https://staticnails.com/",
    role: "Email Design",
    desc: "Designed campaigns for a press-on nail and beauty DTC brand.",
